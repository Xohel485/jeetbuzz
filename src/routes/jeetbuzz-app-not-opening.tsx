  ...
  component: () => (
    <GuidePage
      ...
      body={[
        ...
        "1. Uninstall the app.",
        "2. Restart the phone.",
        "3. Download the current APK from the official site — see [APK Download](/download).",
        ...
        "- [APK Download](/download) — safe download path.",
      ...
      bodyByLocale={{
        bn: [
          ...
          "১. Uninstall।",
          "২. Restart ফোন।",
          "৩. অফিসিয়াল সাইট থেকে APK — [APK Download](/download)।",
          "৪. Install ও লগইন।",
