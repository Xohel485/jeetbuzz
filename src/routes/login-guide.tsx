    ...
    <GuidePage
      ...
      bodyByLocale={{
        ...
        ur: [
          ...
          "## JeetBuzz لاگ ان نہیں کھل رہا؟ متبادل ورکنگ لنک",
          "اگر پاکستان میں مرکزی JeetBuzz لاگ ان صفحہ نہ کھلے تو آپریٹر اضافی ورکنگ رسائی پوائنٹس شائع کرتا ہے۔ سب سے محفوظ طریقہ اوپر دیا گیا تصدیق شدہ آؤٹ باؤنڈ بٹن ہے, جب JeetBuzz اپنا ڈومین تبدیل کرتا ہے، ہم لنک کو فوری طور پر اپڈیٹ رکھتے ہیں۔",
          "- اوپر کا 'JeetBuzz لاگ ان پر جائیں' بٹن استعمال کریں, یہ موجودہ لائیو URL پر خود کار طور پر ری ڈائریکٹ کرتا ہے۔",
          "- جس صفحے پر پہنچیں اسے بُک مارک کر لیں تاکہ اگلی بار براہ راست واپس آ سکیں۔",
          "- ڈومین اچانک آف لائن ہو تو GetJeetBuzz پر واپس آئیں. JeetBuzz کی نئی رسائی URL یہاں اپڈیٹ ہو جاتی ہے۔",
          "## 'JeetBuzz سائٹ نہیں کھل رہی', 2 منٹ میں حل",
          "1. نیٹ ورک تبدیل کریں. Wi-Fi سے موبائل ڈیٹا پر جائیں یا اس کے برعکس۔ زیادہ تر ISP بلاک صرف ایک نیٹ ورک پر لاگو ہوتے ہیں۔",
          "2. اپنے فون کی Wi-Fi سیٹنگز میں DNS کو 1.1.1.1 (Cloudflare) یا 8.8.8.8 (Google) پر تبدیل کریں, یہ 'this site can't be reached' کی اکثر شکایات حل کرتا ہے۔",
          "3. jeetbuzz.com کے لیے براؤزر کیش صاف کریں اور اسی صفحے سے دوبارہ کلک کریں۔",
          "4. JeetBuzz Android APK آزمائیں, [APK گائیڈ](/apk-download-guide) دیکھیں۔ ایپ زیادہ تر DNS بلاکس کو نظرانداز کر دیتی ہے۔",
          "5. پھر بھی مسئلہ ہو تو JeetBuzz سائٹ پر 24/7 لائیو چیٹ کھول کر موجودہ ورکنگ URL پوچھیں. WhatsApp یا Telegram پر کسی اجنبی کا بھیجا لنک ہرگز نہ کھولیں۔",
          "## جعلی JeetBuzz لاگ ان مرر کیسے پہچانیں",
          "- اصل JeetBuzz لاگ ان HTTPS پر ہے اور سرٹیفکیٹ وارننگ نہیں آتی۔",
          "- لوگو، رنگ اور اردو متن آفیشل سائٹ سے بالکل مطابقت رکھتے ہیں۔",
          "- لاگ ان پر کبھی JazzCash یا EasyPaisa PIN یا OTP نہیں مانگا جاتا, صرف آپ کا JeetBuzz پاس ورڈ۔",
          "- ذرا سا شبہ ہو تو ٹیب بند کریں اور اوپر کے تصدیق شدہ بٹن سے دوبارہ کھولیں۔",
          "## سیکیورٹی چیک لسٹ",
