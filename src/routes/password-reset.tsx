...
export const Route = createFileRoute("/password-reset")({
  head: () => ({
    meta: [
      { title: "JeetBuzz Password Reset 2026. OTP & Email Recovery" },
    ...
    links: [canonicalLink("/password-reset"), ...hreflangLinks("password-reset")],
  }),
  component: () => (
    <GuidePage
      ...
      bodyByLocale={{
        ...
        hi: [
          "## संक्षिप्त सारांश",
          "JeetBuzz पासवर्ड रीसेट दो तरीक़ों से किया जा सकता है: रजिस्टर्ड Jio/Airtel/Vi/BSNL नंबर पर OTP, या रजिस्टर्ड ईमेल पर भेजा गया single-use लिंक। थोड़े समय में बहुत-सी रीसेट कोशिशें करने पर सिस्टम सुरक्षा के लिए अस्थायी cooldown लगा सकता है।",
          "## फ़ोन OTP से रीसेट",
          "1. ऑफ़िशियल JeetBuzz लॉगिन पेज खोलें।",
          "2. ‘Forgot password’ पर टैप करें।",
          "3. अपना रजिस्टर्ड नंबर डालें (+91 के साथ)।",
          "4. कुछ ही समय में 6 अंकों का OTP आएगा। छोटे ऑपरेटरों (जैसे BSNL) पर थोड़ी देरी सामान्य है. Resend दबाने से पहले पूरा एक मिनट इंतज़ार करें।",
          "5. नया पासवर्ड सेट करें, कम से कम 12 अक्षर, अक्षर/अंक/चिह्न का मिश्रण।",
          "## ईमेल रीसेट लिंक",
          "वही फ़्लो, OTP की जगह एक single-use लिंक जो थोड़े समय में expire हो जाता है। Gmail में Spam और Promotions फ़ोल्डर ज़रूर देखें और लिंक आते ही बिना देरी क्लिक करें।",
          "## रिकवरी फेल होने पर",
          ...
          "## रीसेट के बाद",
          "एक बार लॉगिन करके अकाउंट सेटिंग्स में देख लें कि दो-चरण सत्यापन ([Login Security](/login-security)) आपके अकाउंट पर उपलब्ध है या नहीं, और जहाँ ऑपरेटर समर्थन करता है वहाँ इसे चालू कर लें। नया पासवर्ड कभी अपने UPI PIN, PhonePe PIN या Gmail पासवर्ड जैसा न रखें।",
      ...
      faqsByLocale={{
        ...
        hi: [
          ...
          { q: "ईमेल लिंक कितनी देर में expire होता है?", a: "यह single-use होता है और थोड़े ही समय में expire हो जाता है। मिलते ही बिना देरी क्लिक करें; एक बार इस्तेमाल के बाद दोबारा काम नहीं करेगा।" },
          { q: "नया पासवर्ड कैसा होना चाहिए?", a: "12+ अक्षर, बड़े/छोटे, अंक और चिह्न। अपना फ़ोन नंबर या जन्म वर्ष इस्तेमाल न करें।" },
          { q: "एक ही दिन में कितनी बार रीसेट की कोशिश की जा सकती है?", a: "कोई निश्चित संख्या सार्वजनिक रूप से घोषित नहीं है, मगर थोड़े समय में बार-बार अनुरोध भेजने पर सिस्टम सुरक्षा के लिए नई request अस्थायी तौर पर रोक देता है। कुछ देर बाद दोबारा कोशिश करें।" },
          { q: "रीसेट के बाद दो-चरण सत्यापन (2FA) चालू रहता है?", a: "सिर्फ़ पासवर्ड रीसेट से 2FA सेटिंग बदलती नहीं, जैसी पहले थी वैसी ही रहती है। फिर भी रीसेट के बाद Account → Security में एक बार जाँच कर लेना अच्छा है।" },
          { q: "BSNL या छोटे ऑपरेटरों पर OTP देर से क्यों आता है?", a: "छोटे ऑपरेटरों का इंटरनेशनल SMS रूट अपेक्षाकृत धीमा होता है। कुछ देर और इंतज़ार करें; बार-बार Resend दबाने पर सिस्टम rate-limit लगा सकता है।" },
          { q: "अकाउंट पूरी तरह लॉक हो जाए तो क्या करें?", a: "ऑफ़िशियल लाइव चैट से संपर्क करें; पहचान सत्यापन के लिए Aadhaar/PAN की फ़ोटो और हालिया डिपॉज़िट/withdrawal ID तैयार रखें। कितने समय में हल होगा इसकी पहले से गारंटी नहीं दी जा सकती।" },
        ],
      }}
