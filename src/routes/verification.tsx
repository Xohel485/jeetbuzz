    ...
    <GuidePage
      ...
      bodyByLocale={{
        bn: [
          ...
          "Grameenphone, Robi, Banglalink বা Teletalk — যেই অপারেটরই হোক, ৬-ডিজিটের OTP ৬০ সেকেন্ডের মধ্যে আসে। Teletalk-এ মাঝে মাঝে ১–২ মিনিট দেরি হয়। OTP না এলে 'Resend' এ ট্যাপ করুন; তবু না এলে নেটওয়ার্ক বদলে দেখুন।",
          ...
          "নির্দিষ্ট থ্রেশহোল্ডের (সাধারণত প্রথম বড় উইথড্রয়াল বা ৫০,০০০৳+) পর জিতবাজ চাইবে:",
          ...
          "## KYC কত সময় লাগে?",
          "সাধারণত অফিস টাইমে ২–২৪ ঘণ্টা। শুক্রবার/শনিবার বা ঈদ-পূজার ছুটিতে ৪৮ ঘণ্টা পর্যন্ত লাগতে পারে। রিভিউ চলাকালীন ডিপোজিট/বেট বন্ধ হয় না, শুধু উইথড্রয়াল হোল্ডে থাকে।",
          "## সাধারণ রিজেকশন",
        ...
        ur: [
          ...
          "Jazz, Zong, Ufone یا Telenor — کسی بھی نیٹ ورک پر 60 سیکنڈ کے اندر 6 ہندسوں کا OTP آجاتا ہے۔ Ufone پر بعض اوقات 1–2 منٹ کی تاخیر ہوتی ہے۔ نہ آنے پر 'Resend' دبائیں یا Wi-Fi چھوڑ کر موبائل ڈیٹا پر آئیں۔",
          ...
          "حد عبور کرنے پر (عموماً پہلی بڑی ودڈرا یا 50,000 PKR+) JeetBuzz درج ذیل مانگتا ہے:",
          ...
          "عام طور پر دفتر کے اوقات میں 2–24 گھنٹے۔ ہفتہ، اتوار یا عید کی چھٹیوں میں 48 گھنٹے تک۔ جائزہ کے دوران ڈپازٹ اور بیٹنگ بند نہیں ہوتی، صرف ودڈرا روک دی جاتی ہے۔",
          "## عام رد کی وجوہات",
        ...
        hi: [
          ...
          "Jio, Airtel, Vi या BSNL — किसी भी ऑपरेटर पर 60 सेकंड के अंदर 6-डिजिट OTP आ जाता है। BSNL पर कभी-कभी 1–2 मिनट की देरी होती है। OTP न आए तो 'Resend' दबाएँ या Wi-Fi छोड़कर मोबाइल डेटा पर आएँ।",
          ...
          "आम तौर पर ऑफ़िस घंटों में 2–24 घंटे। शनिवार/रविवार या होली, दिवाली, ईद की छुट्टियों में 48 घंटे तक। रिव्यू के दौरान डिपॉज़िट और बेटिंग बंद नहीं होती, सिर्फ़ निकासी रुक जाती है।",
      ...
      faqsByLocale={{
        bn: [
          { q: "KYC ছাড়া কি উইথড্রয়াল করা যায়?", a: "ছোট অ্যামাউন্ট (সাধারণত ১০,০০০৳-এর নিচে) সাধারণত যায়। কিন্তু কিউমুলেটিভ লিমিট পেরোলে KYC বাধ্যতামূলক।" },
          { q: "NID-র জায়গায় পাসপোর্ট দিতে পারব?", a: "হ্যাঁ, কিন্তু NID দ্রুত প্রসেস হয়। বিদেশে বসবাসকারী বাংলাদেশিরা পাসপোর্ট দিন।" },
          { q: "Teletalk-এ OTP আসছে না — কী করব?", a: "Teletalk-এর আন্তর্জাতিক SMS রুট ধীর। ১২০ সেকেন্ড অপেক্ষা করুন, না এলে Grameenphone/Robi নম্বরে রি-রেজিস্টার করুন।" },
          ...
          { q: "KYC কতদিনে হয়?", a: "সাধারণত ২–২৪ ঘণ্টা; শুক্র-শনি বা ছুটিতে ৪৮ ঘণ্টা পর্যন্ত।" },
          ...
          { q: "KYC ডেটা কোথায় রাখা হয়?", a: "জিতবাজের Curaçao লাইসেন্সের অধীনে এনক্রিপ্টেড সার্ভারে। শুধু কমপ্লায়েন্স টিম দেখতে পারে।" },
          { q: "১৭ বছর বয়সে রেজিস্টার করলে কী হবে?", a: "KYC ফেইল হবে, অ্যাকাউন্ট বন্ধ হবে এবং ডিপোজিট ফেরত নাও আসতে পারে। ১৮+ হওয়ার পর তবেই খেলুন।" },
        ],
        ur: [
          { q: "KYC کے بغیر ودڈرا ہو سکتی ہے؟", a: "چھوٹی رقم (عموماً 10,000 PKR سے کم) عموماً نکل جاتی ہے۔ کیومولیٹو حد عبور کرنے پر KYC لازمی ہے۔" },
          { q: "CNIC کے بجائے پاسپورٹ دے سکتا ہوں؟", a: "ہاں، لیکن CNIC جلدی پروسیس ہوتا ہے۔ بیرون ملک مقیم پاکستانی پاسپورٹ دیں۔" },
          { q: "Ufone پر OTP نہیں آرہا — کیا کروں؟", a: "Ufone کا انٹرنیشنل SMS روٹ سست ہے۔ 120 سیکنڈ انتظار کریں، نہ آنے پر Jazz/Zong نمبر سے دوبارہ رجسٹر کریں۔" },
          ...
          { q: "KYC کتنے دن میں ہوتا ہے؟", a: "عموماً 2–24 گھنٹے؛ ہفتہ/اتوار یا عید کی چھٹیوں میں 48 گھنٹے تک۔" },
          ...
          { q: "KYC ڈیٹا کہاں رکھا جاتا ہے؟", a: "JeetBuzz کے Curaçao لائسنس کے تحت انکرپٹڈ سرورز پر۔ صرف کمپلائنس ٹیم دیکھ سکتی ہے۔" },
          { q: "17 سال کی عمر میں رجسٹر کرنے پر کیا ہو گا؟", a: "KYC ناکام ہو گی، اکاؤنٹ بند ہو گا اور ڈپازٹ واپس نہ ملنے کا خطرہ ہے۔ صرف 18+۔" },
        ],
        hi: [
          { q: "KYC के बिना निकासी हो सकती है?", a: "छोटी रकम (आम तौर पर ₹10,000 से कम) निकल जाती है। कुल सीमा पार करने पर KYC अनिवार्य।" },
          ...
          { q: "KYC कितने दिन में होता है?", a: "आम तौर पर 2–24 घंटे; शनिवार/रविवार या होली, दिवाली में 48 घंटे तक।" },
          ...
          { q: "KYC डेटा कहाँ रखा जाता है?", a: "JeetBuzz के Curaçao लाइसेंस के तहत एन्क्रिप्टेड सर्वर पर। केवल कंप्लायंस टीम देख सकती है।" },
