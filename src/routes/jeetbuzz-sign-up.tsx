  ...
  component: () => (
    <GuidePage
      ...
      body={[
        ...
        "The registration form is identical across the Android APK, the iOS web app and the desktop site. On mobile, tap **Menu → Sign Up**; on desktop it's the gold button top-right. The Android APK autofills the OTP so you never leave the app — see [APK Download](/jeetbuzz-apk-download).",
      ...
      faqs={[
        ...
        { q: "Can I sign up on the JeetBuzz app instead of the website?", a: "Yes. The Android APK and iOS web app carry the same signup form. On Android the OTP autofills, so it is often faster — download from [JeetBuzz APK Download](/jeetbuzz-apk-download)." },
      ...
      faqsByLocale={{
        bn: [
          ...
          { q: "অ্যাপ থেকে সাইনআপ করা যায়?", a: "হ্যাঁ। Android APK ও iOS ওয়েব অ্যাপে একই সাইনআপ ফর্ম। Android-এ OTP অটো-ফিল হয়, তাই প্রায়ই দ্রুত — [JeetBuzz APK Download](/jeetbuzz-apk-download)।" },
