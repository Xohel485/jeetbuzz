...
export const Route = createFileRoute("/payment-methods")({
  ...
  component: () => (
    <GuidePage
      ...
      bodyByLocale={{
        bn: [
          "> **এক নজরে:** জিতবাজ বাংলাদেশের প্লেয়াররা bKash, Nagad বা Rocket ব্যবহার করেন (ইনস্ট্যান্ট, ২০০ টাকা মিনিমাম, ০% ফি)। বড় উইথড্রয়ালের জন্য USDT TRC20 দ্রুততম। যেই ওয়ালেট দিয়ে ডিপোজিট করেছেন সেটিতেই উইথড্র করলে সবচেয়ে দ্রুত ক্লিয়ার হয়।",
          "## দ্রুত তুলনা",
          ...
          "|---|---|---|---|---|---|",
          "| bKash | বাংলাদেশ | ২০০ টাকা | ইনস্ট্যান্ট | ৫–৩০ মিনিট | ০% |",
          "| Nagad | বাংলাদেশ | ২০০ টাকা | ইনস্ট্যান্ট | ৫–৩০ মিনিট | ০% |",
          "| Rocket | বাংলাদেশ | ৩০০ টাকা | ইনস্ট্যান্ট – ৫ মিনিট | ৩০–৬০ মিনিট | ০% |",
          "| Upay | বাংলাদেশ | ৩০০ টাকা | ইনস্ট্যান্ট | ৩০–৬০ মিনিট | ০% |",
          "| USDT (TRC20/BEP20) | সব | ~$১০ | ১–৩ কনফার্ম | ১০–৩০ মিনিট | নেটওয়ার্ক গ্যাস |",
          "## সাফল্যের হার (কমিউনিটি রিপোর্ট, ২০২৬)",
          "এই সংখ্যাগুলো আমাদের আউটরিচ প্যানেলের গত ৯০ দিনের ব্যবহারকারী রিপোর্ট থেকে — দিকনির্দেশনা হিসেবে দেখুন, গ্যারান্টি নয়।",
          "| মাধ্যম | ডিপোজিট সফল | উইথড্রয়াল সফল | প্রথম প্রচেষ্টায় ব্যর্থতার কারণ |",
          "|---|---|---|---|",
          "| bKash | ৯৭% | ৯৫% | ভুল TrxID / Send Money বনাম Make Payment |",
          "| Nagad | ৯৬% | ৯৪% | রেফারেন্স কোড বাদ পড়া |",
          "| Rocket | ৯৩% | ৯০% | এজেন্ট নেটওয়ার্ক বিলম্ব |",
          "| USDT TRC20 | ৯৯% | ৯৮% | ভুল নেটওয়ার্ক |",
          ...
          "- **bKash** — সবচেয়ে জনপ্রিয়, ইনস্ট্যান্ট, সর্বনিম্ন মিনিমাম, প্রতিদিনের খেলার জন্য সেরা",
