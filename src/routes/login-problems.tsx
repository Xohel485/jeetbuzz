...
export const Route = createFileRoute("/login-problems")({
  head: () => ({
    meta: [
      { title: "JeetBuzz Login Problems 2026. OTP & Access Fixes" },
    ...
    links: [canonicalLink("/login-problems"), ...hreflangLinks("login-problems")],
  }),
  component: () => (
    <GuidePage
      ...
      bodyByLocale={{
        ...
        hi: [
          ...
          "कभी-कभी JeetBuzz का anti-fraud सिस्टम बड़ी डिपॉज़िट के बाद अस्थायी होल्ड लगाता है। लाइव चैट में आख़िरी UPI transaction ID और इस्तेमाल किया गया नंबर तैयार रखकर संपर्क करें; समीक्षा पूरी होने पर अकाउंट सामान्यतः फिर से चालू हो जाता है, लेकिन सही समय पहले से तय नहीं किया जा सकता।",
      ...
      faqsByLocale={{
        ...
        hi: [
          ...
          { q: "UPI/PhonePe डिपॉज़िट के बाद लॉगिन होल्ड?", a: "anti-fraud अस्थायी होल्ड हो सकता है। लाइव चैट में आख़िरी UPI transaction ID शेयर करें; समीक्षा के बाद अकाउंट दोबारा चालू हो जाता है, मगर कितना समय लगेगा यह पहले से तय नहीं।" },
          { q: "OTP कितनी देर में आना चाहिए?", a: "ज़्यादातर केसों में कुछ सेकंड से एक मिनट के अंदर आ जाता है। Resend दबाने से पहले कम से कम पूरा एक मिनट इंतज़ार करें; बार-बार दबाने पर सिस्टम अस्थायी rate-limit लगा सकता है।" },
          ...
          { q: "2FA कोड बार-बार ग़लत हो जाए तो क्या होता है?", a: "सुरक्षा के लिए अकाउंट अस्थायी रूप से लॉक हो सकता है। कुछ देर रुककर दोबारा कोशिश करें; जल्दी अनलॉक चाहिए तो ऑफ़िशियल लाइव चैट से संपर्क करें।" },
