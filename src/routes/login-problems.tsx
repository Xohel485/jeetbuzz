    ...
    <GuidePage
      ...
      bodyByLocale={{
        bn: [
          ...
          "bKash/Nagad/Rocket ডিপোজিটের পর কখনো কখনো অ্যান্টি-ফ্রড সিস্টেম অ্যাকাউন্ট হোল্ড করে। জিতবাজ লাইভ চ্যাটে শেষ ট্রানজেকশন আইডি দিন — সাধারণত ১৫-৩০ মিনিটে আনলক।",
        ...
        ur: [
          ...
          "بعض اوقات JeetBuzz کا anti-fraud سسٹم بڑی ڈپازٹ کے بعد عارضی ہولڈ لگاتا ہے۔ لائیو چیٹ میں آخری ٹرانزیکشن آئی ڈی شیئر کریں — عام طور پر 15-30 منٹ میں اکاؤنٹ بحال۔",
      ...
      faqsByLocale={{
        bn: [
          ...
          { q: "bKash দিয়ে ডিপোজিট করার পর লগইন আটকে গেলে?", a: "অ্যান্টি-ফ্রড হোল্ড হতে পারে। লাইভ চ্যাটে শেষ bKash ট্রানজেকশন আইডি দিন — সাধারণত ১৫-৩০ মিনিটে আনলক হয়।" },
          { q: "OTP কত সেকেন্ডের মধ্যে আসা উচিত?", a: "Grameenphone/Robi-তে ৩০-৬০ সেকেন্ড, Teletalk-এ কখনো ৯০ সেকেন্ড পর্যন্ত। ৬০ সেকেন্ডের আগে Resend দেবেন না।" },
          ...
          { q: "2FA কোড পাঁচবার ভুল গেলে কী হবে?", a: "অ্যাকাউন্ট সাময়িক লকড হয়, ১৫ মিনিট পর আবার চেষ্টা করুন বা লাইভ চ্যাটে অ্যাকাউন্ট আনলক করতে বলুন।" },
        ...
        ur: [
          ...
          { q: "JazzCash/EasyPaisa سے ڈپازٹ کے بعد لاگ ان ہولڈ؟", a: "anti-fraud عارضی ہولڈ ہو سکتا ہے۔ لائیو چیٹ میں آخری JazzCash/EasyPaisa ٹرانزیکشن آئی ڈی شیئر کریں — 15-30 منٹ میں بحال۔" },
          { q: "OTP کتنی دیر میں آنا چاہیے؟", a: "Jazz/Zong پر 30-60 سیکنڈ، Ufone/Telenor پر کبھی 90 سیکنڈ تک۔ پہلے Resend مت دبائیں۔" },
          ...
          { q: "2FA کوڈ 5 بار غلط ہو جائے تو؟", a: "اکاؤنٹ عارضی طور پر لاک، 15 منٹ بعد دوبارہ کوشش کریں یا لائیو چیٹ سے انلاک کروائیں۔" },
