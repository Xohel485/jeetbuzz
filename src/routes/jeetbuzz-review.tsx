...
const BODY_UR: string[] = [
  ...
  "## ادائیگیاں",
  "JazzCash اور EasyPaisa پر ڈپازٹ فوری ہوتا ہے، اور ودڈراول ہمارے ہر ٹیسٹ میں چند گھنٹوں میں اکاؤنٹ تک پہنچ گیا۔ نام درست ہونا ضروری ہے۔",
  "## ایپ اور سائٹ",
...
const BODY_HI: string[] = [
  ...
  "## पेमेंट",
  "UPI, PhonePe और Paytm पर डिपॉज़िट तुरंत होता है, और विदड्रॉल हमारे हर टेस्ट में कुछ घंटों में अकाउंट तक पहुँच गया। नाम मिलान सही रखें तो होल्ड नहीं पड़ता।",
  "## ऐप और साइट",
