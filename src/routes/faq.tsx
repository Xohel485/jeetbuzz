...
const FAQS = [
  ...
  { q: "Are bKash deposits instant?", a: "Usually within minutes once the TrxID is verified. Processing time may vary depending on payment verification, network conditions, and the selected payment method." },
  { q: "How long do withdrawals take?", a: "Usually within minutes to a few hours after KYC is complete. Processing time may vary depending on payment verification, network conditions, and the selected payment method." },
  ...
  { q: "Does JeetBuzz support 2FA?", a: "Where supported by the operator, two-factor authentication can be enabled under Account > Security. If available for your account, SMS-based 2FA is typically the most common option. Availability may vary by region and account type." },
...
const FAQS_BN: FAQItem[] = [
  ...
  { q: "bKash ডিপোজিট কি ইনস্ট্যান্ট?", a: "TrxID যাচাই হওয়ার পর সাধারণত কয়েক মিনিটের মধ্যে জমা হয়। পেমেন্ট যাচাই, নেটওয়ার্ক অবস্থা এবং নির্বাচিত পেমেন্ট পদ্ধতির উপর ভিত্তি করে প্রসেসিং সময় পরিবর্তিত হতে পারে।" },
  { q: "উইথড্রয়াল কত সময় নেয়?", a: "KYC শেষ হলে সাধারণত কয়েক মিনিট থেকে কয়েক ঘণ্টা। পেমেন্ট যাচাই, নেটওয়ার্ক অবস্থা এবং নির্বাচিত পেমেন্ট পদ্ধতির উপর ভিত্তি করে প্রসেসিং সময় পরিবর্তিত হতে পারে।" },
  ...
  { q: "জিতবাজ কি 2FA সমর্থন করে?", a: "যেখানে অপারেটর সমর্থন করে, সেখানে Account > Security থেকে টু-ফ্যাক্টর অথেনটিকেশন চালু করা যায়। আপনার অ্যাকাউন্টের জন্য উপলব্ধ থাকলে SMS-ভিত্তিক 2FA সাধারণত সবচেয়ে প্রচলিত অপশন। অঞ্চল ও অ্যাকাউন্ট টাইপ অনুযায়ী প্রাপ্যতা ভিন্ন হতে পারে।" },
...
const FAQS_UR: FAQItem[] = [
  ...
  { q: "کیا JazzCash ڈپازٹ فوری ہوتا ہے؟", a: "TrxID کی تصدیق کے بعد عام طور پر چند منٹ میں جمع ہو جاتا ہے۔ پراسیسنگ کا وقت پیمنٹ کی تصدیق، نیٹ ورک کی صورتحال اور منتخب پیمنٹ طریقے پر منحصر ہو سکتا ہے۔" },
  { q: "ودڈرا میں کتنا وقت لگتا ہے؟", a: "KYC مکمل ہونے کے بعد عام طور پر چند منٹ سے چند گھنٹے۔ پراسیسنگ کا وقت پیمنٹ کی تصدیق، نیٹ ورک کی صورتحال اور منتخب پیمنٹ طریقے پر منحصر ہو سکتا ہے۔" },
  ...
  { q: "کیا JeetBuzz 2FA سپورٹ کرتا ہے؟", a: "جہاں آپریٹر سپورٹ کرے، وہاں Account > Security سے ٹو فیکٹر آتھنٹیکیشن آن کی جا سکتی ہے۔ اگر آپ کے اکاؤنٹ کے لیے دستیاب ہو تو SMS پر مبنی 2FA عام طور پر سب سے زیادہ مستعمل آپشن ہے۔ دستیابی علاقے اور اکاؤنٹ کی قسم کے مطابق مختلف ہو سکتی ہے۔" },
...
const FAQS_HI: FAQItem[] = [
  ...
  { q: "क्या UPI डिपॉज़िट इंस्टेंट हैं?", a: "TrxID सत्यापित होने के बाद आम तौर पर कुछ मिनट में जमा हो जाते हैं। प्रोसेसिंग समय पेमेंट सत्यापन, नेटवर्क स्थिति और चुने गए पेमेंट तरीक़े पर निर्भर कर सकता है।" },
  { q: "विदड्रॉल में कितना समय लगता है?", a: "KYC पूरा होने पर आम तौर पर कुछ मिनट से कुछ घंटे। प्रोसेसिंग समय पेमेंट सत्यापन, नेटवर्क स्थिति और चुने गए पेमेंट तरीक़े पर निर्भर कर सकता है।" },
  ...
  { q: "क्या JeetBuzz 2FA सपोर्ट करता है?", a: "जहाँ ऑपरेटर सपोर्ट करे, वहाँ Account > Security से टू-फ़ैक्टर ऑथेंटिकेशन ऑन की जा सकती है। यदि आपके खाते के लिए उपलब्ध हो तो SMS-आधारित 2FA आम तौर पर सबसे प्रचलित विकल्प है। उपलब्धता क्षेत्र और खाता प्रकार के अनुसार भिन्न हो सकती है।" },
...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      { title: "JeetBuzz FAQ 2026. Signup, Bonus, bKash & Safety" },
