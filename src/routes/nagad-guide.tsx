    ...
    <GuidePage
      ...
      bodyByLocale={{
        bn: [
          ...
          "## Nagad লিমিট, ফি ও সময়",
          "| অ্যাকশন | মিনিমাম | দৈনিক সর্বোচ্চ | সময় | জিতবাজ ফি |",
          "|---|---|---|---|---|",
          "| ডিপোজিট | ২০০ টাকা | ৭৫,০০০ টাকা | ইনস্ট্যান্ট | ০% |",
          "| উইথড্রয়াল (Bronze) | ৫০০ টাকা | ৩০,০০০ টাকা | ৫–৩০ মিনিট | ০% |",
          "| উইথড্রয়াল (Silver) | ৫০০ টাকা | ১,৫০,০০০ টাকা | ৫–৩০ মিনিট | ০% |",
          "| উইথড্রয়াল (Gold+) | ৫০০ টাকা | ৫,০০,০০০ টাকা | ৫–৩০ মিনিট | ০% |",
          "Nagad-এর নিজস্ব Send Money ফি (সাধারণত ৪ টাকা প্রতি ১,০০০ টাকা) আপনার দিকে প্রযোজ্য; মার্চেন্ট ট্রান্সফারে সাধারণত ফি নেই।",
          "## সমস্যা সমাধান",
      ...
      faqsByLocale={{
        bn: [
          { q: "Nagad কি জিতবাজে bKash-এর চেয়ে দ্রুত?", a: "দুটোই সাধারণত ইনস্ট্যান্ট। পার্থক্য মিনিটের, ঘণ্টার নয়।" },
