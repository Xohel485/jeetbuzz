...
export const Route = createFileRoute("/rocket-guide")({
  ...
  component: () => (
    <GuidePage
      ...
      bodyByLocale={{
        bn: [
          "> **এক নজরে:** Rocket জিতবাজ বাংলাদেশের তৃতীয় স্তম্ভ। Cashier > Deposit > Rocket → Rocket অ্যাপ বা *322# USSD থেকে Send Money → সঠিক পরিমাণে রেফারেন্স কোডসহ পাঠান → TrxID সাবমিট করুন। মিনিমাম ৩০০ টাকা, ইনস্ট্যান্ট থেকে ৫ মিনিটে ক্রেডিট, উইথড্রয়াল ৩০–৬০ মিনিটে।",
          ...
          "## Rocket লিমিট, ফি ও সময়",
          "| অ্যাকশন | মিনিমাম | দৈনিক সর্বোচ্চ | সময় | জিতবাজ ফি |",
          "|---|---|---|---|---|",
          "| ডিপোজিট | ৩০০ টাকা | ৫০,০০০ টাকা | ইনস্ট্যান্ট – ৫ মিনিট | ০% |",
          "| উইথড্রয়াল (Bronze) | ৫০০ টাকা | ২৫,০০০ টাকা | ৩০–৬০ মিনিট | ০% |",
          "| উইথড্রয়াল (Silver) | ৫০০ টাকা | ১,০০,০০০ টাকা | ৩০–৬০ মিনিট | ০% |",
          "| উইথড্রয়াল (Gold+) | ৫০০ টাকা | ৩,০০,০০০ টাকা | ৩০–৬০ মিনিট | ০% |",
          "Rocket-এর নিজস্ব Send Money ফি (প্রতি ১,০০০ টাকায় প্রায় ৫ টাকা) আপনার দিকে প্রযোজ্য।",
          "## সাধারণ ভুল",
